import { Search, Plane, ChevronDown, ChevronLeft, ChevronRight, X, Plus, Minus } from 'lucide-react'
...
export default function SearchBar({ containerClassName }) {
  ...
  const defaultClassName = "relative bg-white/70 dark:bg-brand-emerald-900/70 backdrop-blur-2xl p-5 md:p-6 rounded-[2rem] shadow-2xl border border-white/50 dark:border-white/10 transition-all duration-300 text-left w-full";
